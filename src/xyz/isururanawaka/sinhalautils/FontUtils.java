package xyz.isururanawaka.sinhalautils;

/**
 * Convert unicode text to DL and FM font texts
 *
 * @author Isuru
 */
public class FontUtils {
    ...
    public static String convertUnicodeToDL(String text) {
        text = text.replace(",", "￦");
        text = text.replace(".", "�");
        text = text.replace("(", "￫");
        text = text.replace(")", "￩");
    ...
    public static String convertUnicodeToFM(String text) {
